...
namespace ProHair.NL.Controllers
{
    ...
    public class AvailabilityController : ControllerBase
    {
        ...
        {
            // Güvenli tarih parse (YYYY-MM-DD)
            ...
            // Timezone (parametre varsa onu, yoksa settings)
            ...
            // Hizmet süresi (yoksa slot süresi)
